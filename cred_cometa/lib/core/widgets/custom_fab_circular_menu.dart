...
class CustomFabCircularMenu extends StatefulWidget {
  ...
  @override
  CustomFabCircularMenuState createState() => CustomFabCircularMenuState();
}

class CustomFabCircularMenuState extends State<CustomFabCircularMenu>
  ...
  Widget _applyTransformations(Widget child, int index) {
    ...
    final angle = vector.radians(
      90.0 / (widget.children.length - 1) * index + angleFix,
    );
